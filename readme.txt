...
Once the plugin is installed and activated, from your dashboard navigate to Woocommerce > Add countries, then write the desired ISO code and country name separated by a comma.
You can add as many coutries as you want, just enter each country on a new line.
